...
int mover_PC(struct device_part_arrays, EMfield*, grid*, parameters*, long, int, int, FPpart, int);

/** Interpolation Particle --> Grid: This is for species - Modified signature*/
void interpP2G(struct device_part_arrays, struct device_ids_arrays, struct grid*, long nop);
